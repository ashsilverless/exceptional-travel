...
<html class="no-js" <?php language_attributes(); ?>>
	...
	$action_image = get_field("fixed_action_image", "options");
	$action_url   = get_field("fixed_action_url", "options");?>
	
	<div class="fixed-action">
		
		<a href="<?php echo $action_url; ?>" target="_blank">
			<img src="<?php echo $action_image["url"]; ?>">
		</a>
